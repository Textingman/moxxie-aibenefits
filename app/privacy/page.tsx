          ...
          <div className="flex justify-between items-center h-32">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4">
                ...
                <Link href="/privacy" style={{ color: '#1F4E79' }} className="hover:opacity-80 px-3 py-2 rounded-md text-sm font-medium">
                  Privacy
                </Link>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-lg max-w-none">
          ...
          <p className="mb-6" style={{ color: '#6B7280' }}>
            AI Benefits Agent ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our benefits education service and website at aibenefitsagent.com.
          </p>
          ...
          <p className="mb-6" style={{ color: '#6B7280' }}>
            <strong>No mobile information will be shared or sold to third parties for marketing purposes.</strong> We are committed to protecting your mobile information and will only use it for the purposes outlined in this Privacy Policy, such as providing our benefits education service and communicating with you about your account.
          </p>
          ...
          <ul className="list-disc pl-6 mb-6 space-y-2" style={{ color: '#6B7280' }}>
            <li>Provide and maintain our benefits education service</li>
          ...
          <div className="rounded-lg p-6 mb-8" style={{ backgroundColor: '#FFFFFF', border: '1px solid #E5E7EB' }}>
            <p className="mb-2" style={{ color: '#6B7280' }}><strong>Email:</strong> <a href="mailto:privacy@aibenefitsagent.com" className="font-medium" style={{ color: '#2F8FCB' }}>privacy@aibenefitsagent.com</a></p>
            <p className="mb-2" style={{ color: '#6B7280' }}><strong>Support:</strong> <a href="mailto:support@aibenefitsagent.com" className="font-medium" style={{ color: '#2F8FCB' }}>support@aibenefitsagent.com</a></p>
